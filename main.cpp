...
int main()
{
   ...
   // glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //ourShader.setVec4("color", glm::vec4(0.1f, 0.7f, 0.8f, 1.0f));
        ...
        ourShader.setVec4("color", glm::vec4(0.8f, 0.36f, 0.36f, 1.0f));
        ...
        ourShader.setVec4("color", glm::vec4(0.94f, 0.50f, 0.50f, 1.0f));
        ...
        translateMatrix = glm::translate(identityMatrix, glm::vec3(1.4f, translate_Y, translate_Z));
        ...
        translateMatrix = glm::translate(identityMatrix, glm::vec3(1.4f, translate_Y, 0.9f));
